...
| S20 | stem-deterioration | Stem condition vs CH₄ flux: linear-vs-quadratic model comparison (AIC: bark=hump, wounding=linear) | NEW `rev_figS20_stem-deterioration.R` | — |
