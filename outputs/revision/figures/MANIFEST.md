...
| S04 | scale-dependent-genes | Scale-dependent gene patterns, **3-column** | REBUILT `rev_figS04_scale-dependent.R` | old S11 |
| S05 | mcra-vs-methanotroph | mcrA vs methanotroph | orig | old S14 |
| S06 | pmoa-mmox-coupling | pmoA/mmoX coupling & composition (4-compartment) | REBUILT `rev_figS06_pmoa-mmox-coupling.R` | old S10 |
| S07 | pmoa-mmox-by-compartment | pmoA vs mmoX by compartment (abundances) | NEW `rev_figS07_pmoa-mmox-compartment.R` | — |
...
| S15 | isotope-sources | Extended-isotope source composite | BUILT `rev_figS15_isotope-sources.R` | — |
...
| S20 | plant-traits | Plant-trait × methane-cycling heatmap (clade-robust) | NEW `rev_figS20_plant-traits.R` | — |
