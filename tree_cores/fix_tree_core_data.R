# Median Imputation for Problematic Tree Core Measurements
# This creates a "filled" dataset where problematic values are replaced with species x section medians

library(dplyr)
library(readr)

# Read and process data (same as before)
data <- read_csv('/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/tree_cores/Tree Core Sectioning Data.csv')
...
write_csv(final_filled_data, "tree_core_data_filled.csv")
...
# Save results
write_csv(results_summary, "tree_core_filled_results.csv")
write_csv(final_data, "tree_core_filled_complete.csv")
write_csv(all_stats, "tree_core_filled_statistics.csv")
