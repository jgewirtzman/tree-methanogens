# ==============================================================================
# Spatial Interpolation (Elevation, Moisture, Flux)
# ==============================================================================
# Purpose: Comprehensive spatial analysis: elevation, moisture, and flux mapping
#   with interpolation.
#
# Pipeline stage: 3 — Spatial Setup
#
# Inputs:
#   - soil_moisture_20201216.csv (from data/raw/inventory/spatial_data/)
#   - plots.csv (from data/raw/inventory/)
#   - River.xlsx (from data/raw/inventory/spatial_data/)
#   - elevation data (from data/raw/inventory/spatial_data/)
#
# Outputs:
#   - spatial maps, analysis tables (to outputs/)
# ==============================================================================
