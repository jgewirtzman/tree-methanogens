# ==============================================================================
# Check ddPCR Data Completeness
# ==============================================================================
# Purpose: Quality control checking data completeness of ddPCR results across
#   all trees and gene targets.
#
# Pipeline stage: 01 Molecular Processing
# Run after: 01_import_and_align.R
#
# Inputs:
#   - Processed ddPCR data (in memory or from 01_import_and_align.R)
#
# Outputs:
#   - Completeness report (console output)
# ==============================================================================
