...
#!/usr/bin/env Rscript
# ==============================================================================
# wai_bottomup_and_rf_interactions.R
# ------------------------------------------------------------------------------
...
# sole producer of the bottom-up WAI that scaling_full_grid.R consumes, where it
...
# that inventory_build.R replaced with one documented rule. canonical_inventory()
# returns diameters already unit-checked and typo-repaired, and H from the single
# allometry in geometry.R.
...
# One allometry, defined in geometry.R. It was copy-pasted verbatim into five
...
# EXPORT, so scaling_full_grid.R reads these instead of carrying its own copy.
