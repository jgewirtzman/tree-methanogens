#!/usr/bin/env Rscript
# ==============================================================================
# stat_campaign_counts.R  —  REPRODUCIBLE campaign / sample-size accounting
# ------------------------------------------------------------------------------
...
#
# Run from repo root:  Rscript code/09_tables_stats/stat_campaign_counts.R
...
# Same correction applied in stat_dbh_by_species_campaign.R -- without it the 2021
...
cat("Source: code/09_tables_stats/stat_campaign_counts.R\n"); cat(strrep("=",78),"\n\n")
