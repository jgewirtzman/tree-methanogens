# ==============================================================================
# Static Chamber Tree Flux Calculation - 2023 (goFlux)
# ==============================================================================
# Purpose: Static chamber tree flux calculation for 2023 data, extends the
#   main dataset.
#
# Pipeline stage: 01 Flux Processing (static)
# Run after: 01_prep_auxfile_2023.R
#
# Inputs:
#   - ymf2023_goflux_auxfile.csv (from 01_prep_auxfile_2023.R)
...
# Set data path
data_path <- '../../../data/raw/lgr/static_2023'
...
# Load LGR3 auxfile
lgr3_auxfile <- read_csv('../../../data/processed/flux/ymf2023_goflux_auxfile.csv') %>%
