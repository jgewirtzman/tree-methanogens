# ==============================================================================
# Semirigid Tree Flux Calculation (goFlux)
# ==============================================================================
# Purpose: Main semirigid tree flux calculation using goFlux package on LGR3
#   data (2020-2021 campaigns).
#
# Pipeline stage: 01 Flux Processing (semirigid)
# Run after: 03_prep_tree_auxfile.R
#
# Inputs:
#   - Raw LGR3 data files (from data/raw/lgr/semirigid_2020-2021/)
#   - auxfile_goFlux_with_weather.csv (from 03_prep_tree_auxfile.R)
#
# Outputs:
