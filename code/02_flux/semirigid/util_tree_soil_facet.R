# ==============================================================================
# Faceted Tree vs Soil Flux Plots
# ==============================================================================
# Purpose: Faceted time series plots comparing tree and soil flux measurements
#   from semirigid chambers.
# ==============================================================================
...
# Optional: Save plots
# ggsave("../../../outputs/figures/soil_ch4_flux_plot.png", soil_ch4_plot, width = 12, height = 8, dpi = 300)
# ggsave("../../../outputs/figures/combined_ch4_flux_plot.png", combined_ch4_plot, width = 12, height = 8, dpi = 300)
# ggsave("../../../outputs/figures/faceted_ch4_flux_plot.png", faceted_ch4_plot, width = 14, height = 8, dpi = 300)
