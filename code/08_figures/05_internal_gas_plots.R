...
# Save beeswarm figure (Fig S7)
ggsave("outputs/figures/legacy/supplementary/figS7_internal_gas_beeswarm.png",
...
ggsave("outputs/figures/legacy/supplementary/figS8_internal_gas_profiles.png",
