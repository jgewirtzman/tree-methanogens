...
# that inventory_build.R replaced with one documented rule. The species line also
# carried the ladder bug -- see species_levels.R.
INVFILE <- "outputs/tables/inventory_stems.csv"
if (!file.exists(INVFILE))
  stop("missing ", INVFILE, " -- run inventory_build.R first")
