...
## budget_canonical.R from the locked model, with both terms per m2 of GROUND.
...
#        width = 15, height = 11, dpi = 300)
ggsave("outputs/figures/original/supplementary/figS15_rf_predictions.png", final_fig_3row_alt,
