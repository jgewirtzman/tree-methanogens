...
#    recomputed Penman-Monteith ET (see wb_reference_et.R -- the logger's own
...
if (!file.exists(WB)) stop("missing ", WB, " -- run code/04_drivers/wb_reference_et.R first")
...
cat(sprintf("MOISTURE CLIMATOLOGY (moisture_climatology.R)\nbuilt %s\n\n",
