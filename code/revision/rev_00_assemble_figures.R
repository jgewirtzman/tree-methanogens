...
SI <- c(
  ...
  "Figure_S03_rf-flux-predictions"       = "outputs/figures/supplementary/figS15_rf_predictions.png",
  "Figure_S04_scale-dependent-genes"     = "outputs/revision/figS11_final.png",
  ...
  "Figure_S12_picrust-mcra-no-mcra"      = "outputs/figures/main/fig6_picrust_mcra_no_mcra_heatmap.png",  # demoted main Fig 6
  "Figure_S13_picrust-pmoa"              = "outputs/figures/supplementary/figS5_picrust_pmoa_heatmap.png",
  "Figure_S14_d13ch4-raincloud"          = "outputs/figures/supplementary/figS9_d13ch4_rainfall.png",
  "Figure_S15_isotope-sources"           = "outputs/revision/SI_isotopes_source_composite.png",
  "Figure_S16_internal-gas-beeswarm"     = "outputs/figures/supplementary/figS7_internal_gas_beeswarm.png",
  "Figure_S17_internal-gas-profiles"     = "outputs/figures/supplementary/figS8_internal_gas_profiles.png",
  "Figure_S18_black-oak-methanome"       = "outputs/figures/supplementary/figS12_black_oak_methanome.png",
  "Figure_S19_radial-sections"           = "outputs/figures/supplementary/figS13_tree_radial_sections.png",
  "Figure_S20_plant-traits"              = "outputs/revision/traits_heatmap_robust.png")
