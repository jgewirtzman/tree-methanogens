...
#
# NEW file; edits nothing. Run: Rscript code/revision/R_isotopes_provenance_hwsw.R
# Outputs: outputs/revision/iso_hwsw_*.png, iso_provenance_summary.txt, iso_hwsw_paired.csv
# ==============================================================================
