...
# NEW file. Run: Rscript code/revision/R_fig_hydrogenotrophy.R -> fig_hydrogenotrophy.png
# ==============================================================================
...
# Three evidence-graded groups (see code/revision/notes/panel_a_taxa_citations.md):
