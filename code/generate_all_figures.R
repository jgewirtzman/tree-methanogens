...
#
# Outputs:
#   - outputs/figures/original/main/fig1-fig9
#   - outputs/figures/original/supplementary/figS1-figS15
# ==============================================================================
...
run_figure_script("code/08_figures/06_soil_tree_timeseries.R",          "fig1")
run_figure_script("code/02_flux/static/04_height_effect_analysis.R", "fig2")
run_figure_script("code/08_figures/04_variance_partition.R",             "fig3")
run_figure_script("code/08_figures/util_combined_plot.R",                  "fig4")
run_figure_script("code/08_figures/08c_combined_methane_cycling_composition.R", "fig5")
run_figure_script("code/08_figures/12b_picrust_pathway_heatmap.R",       "fig6")
run_figure_script("code/08_figures/09_felled_oak_profiles.R",            "fig7")
...
run_figure_script("code/08_figures/12c_taxonomy_pmoa_heatmap.R",         "S2")
run_figure_script("code/08_figures/08d_faprotax_heatmaps.R",             "S3")
# S4, S5 already generated by fig6 script (12b_picrust_pathway_heatmap.R)
run_figure_script("code/08_figures/12a_taxonomy_mcra_heatmap.R",         "S6")
run_figure_script("code/08_figures/05_internal_gas_plots.R",             "S7, S8")
run_figure_script("code/08_figures/11a_isotope_d13ch4_single.R",         "S9")
run_figure_script("code/07_molecular/methanotrophs/03_pmoa_mmox_analysis.R", "S10")

# S11, S14 generated by 02_scale_dependent (already sourced as part of fig8)

run_figure_script("code/08_figures/10_black_oak_methanome_heatmap.R",    "S12")
run_figure_script("code/08_figures/02_radial_cross_sections.R",          "S13")
