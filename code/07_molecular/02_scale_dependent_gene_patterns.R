...
ggsave("outputs/figures/legacy/supplementary/figS11_scale_dependent_genes.png", combined_layout,
...
#        width = 12, height = 5)
ggsave("outputs/figures/legacy/supplementary/figS14_mcra_vs_methanotroph.png", mcra_vs_methanotroph_layout,
