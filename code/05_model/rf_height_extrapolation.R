...
# typo-repaired by inventory_build.R, so this local stack was re-repairing repaired
...
# Height comes from the single allometry in geometry.R (canonical_inventory() has
