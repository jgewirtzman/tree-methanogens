# ==============================================================================
# Site Map of Methanogen Abundance
# ==============================================================================
# Purpose: Spatial map of methanogen abundance at the study site.
#
...
# Save the map
ggsave("../../../outputs/figures/yale_myers_forest_map.png", final_map, width = 10, height = 7, dpi = 300)
