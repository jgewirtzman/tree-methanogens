...
# Save all plots
ggsave("stem_map_moisture_overlay.png", stem_moisture_overlay, width = 16, height = 10, dpi = 300)
ggsave("tree_distribution_moisture.png", tree_distribution_plot, width = 14, height = 10, dpi = 300)
ggsave("transformation_methods_moisture.png", transformation_comparison, width = 12, height = 8, dpi = 300)
...
# Save plots
ggsave("extended_moisture_stem_overlay.png", extended_overlay_plot, width = 16, height = 10, dpi = 300)
ggsave("interpolation_extent_comparison.png", extent_comparison, width = 12, height = 8, dpi = 300)
...
# Save all plots
ggsave("extended_akima_interpolation.png", p1, width = 12, height = 8, dpi = 300)
ggsave("tps_interpolation.png", p2, width = 12, height = 8, dpi = 300)
ggsave("gam_interpolation.png", p3, width = 12, height = 8, dpi = 300)
ggsave("final_extended_moisture_overlay.png", final_extended_plot, width = 16, height = 10, dpi = 300)
