# Tree Chamber Distribution Plots by Sample ID
# Visualize diameter, volume, and surface area distributions
...
# Save plots
ggsave("stem_diameter_by_sample.png", p1, width = 12, height = 8, dpi = 300)
ggsave("surface_area_by_sample.png", p2, width = 12, height = 8, dpi = 300)
ggsave("volume_by_sample.png", p3, width = 12, height = 8, dpi = 300)
ggsave("diameter_vs_surface_area.png", p4, width = 10, height = 8, dpi = 300)
ggsave("volume_vs_surface_area.png", p5, width = 10, height = 8, dpi = 300)
ggsave("coefficient_variation.png", p6, width = 12, height = 8, dpi = 300)
...
if (nrow(multiple_measurements) > 0) {
  ...
  ggsave("surface_area_cv_distribution.png", p1, width = 10, height = 6, dpi = 300)
  ggsave("surface_area_consistency_plot.png", p2, width = 10, height = 6, dpi = 300)
  ggsave("volume_consistency_plot.png", p3, width = 10, height = 6, dpi = 300)
