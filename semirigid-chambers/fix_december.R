# December-Only LGR3 Flux Processing Workflow
...
for(batch_num in 1:num_batches) {
  ...
  manID_batch <- click.peak2(
    ...
    sleep = 3,
    plot.lim = c(200, 5000),
    save.plots = paste0("flux_code/lgr3_december_batch_", batch_num, "_plots")
  )
...
write_csv(manID.lgr3.december, "flux_code/lgr_manual_identification_results_december_soil.csv")
...
flux2pdf(
  ...
  outfile = "flux_code/LGR3_flux_plots_december_soil.pdf",
  width = 11.6,
  height = 8.2
)
...
if(file.exists("flux_code/lgr_manual_identification_results_soil.csv")) {
  existing_manID <- read_csv("flux_code/lgr_manual_identification_results_soil.csv") %>%
  ...
  write_csv(updated_manID, "flux_code/lgr_manual_identification_results_soil.csv")
  ...
  write_csv(manID.lgr3.december, "flux_code/lgr_manual_identification_results_soil.csv")
...
if(file.exists("flux_code/CO2_flux_lgr_results_soil.csv")) {
  existing_CO2_flux <- read_csv("flux_code/CO2_flux_lgr_results_soil.csv")
  ...
  write_csv(updated_CO2_flux, "flux_code/CO2_flux_lgr_results_soil.csv")
  ...
  # If original doesn't exist, just save December data
  write_csv(CO2_flux_lgr3_december, "flux_code/CO2_flux_lgr_results_soil.csv")
...
if(file.exists("flux_code/CO2_best_flux_lgr_results_soil.csv")) {
  existing_CO2_best <- read_csv("flux_code/CO2_best_flux_lgr_results_soil.csv")
  ...
  write_csv(updated_CO2_best, "flux_code/CO2_best_flux_lgr_results_soil.csv")
  ...
  # If original doesn't exist, just save December data
  write_csv(CO2_best_lgr3_december, "flux_code/CO2_best_flux_lgr_results_soil.csv")
...
if(exists("CH4_flux_lgr3_december")) {
  ...
  if(file.exists("flux_code/CH4_flux_lgr_results_soil.csv")) {
    existing_CH4_flux <- read_csv("flux_code/CH4_flux_lgr_results_soil.csv")
    ...
    write_csv(updated_CH4_flux, "flux_code/CH4_flux_lgr_results_soil.csv")
    ...
    # If original doesn't exist, just save December data
    write_csv(CH4_flux_lgr3_december, "flux_code/CH4_flux_lgr_results_soil.csv")
...
if(exists("CH4_best_lgr3_december")) {
  ...
  if(file.exists("flux_code/CH4_best_flux_lgr_results_soil.csv")) {
    existing_CH4_best <- read_csv("flux_code/CH4_best_flux_lgr_results_soil.csv")
    ...
    write_csv(updated_CH4_best, "flux_code/CH4_best_flux_lgr_results_soil.csv")
    
    cat("CH4 best flux results updated:", nrow(updated_CH4_best), "total rows\n")
  } else {
    # If original doesn't exist, just save December data
    write_csv(CH4_best_lgr3_december, "flux_code/CH4_best_flux_lgr_results_soil.csv")
...
existing_dataset <- read_csv("flux_code/semirigid_tree_final_complete_dataset_soil.csv")
...
write_csv(updated_final_dataset, "flux_code/semirigid_tree_final_complete_dataset_soil.csv")
...
updated_manID_complete <- read_csv("flux_code/lgr_manual_identification_results_soil.csv")
updated_CO2_best_complete <- read_csv("flux_code/CO2_best_flux_lgr_results_soil.csv")
...
if(file.exists("flux_code/CH4_best_flux_lgr_results_soil.csv")) {
  updated_CH4_best_complete <- read_csv("flux_code/CH4_best_flux_lgr_results_soil.csv")
...
write_csv(CO2_best_lgr3_december, "flux_code/CO2_best_flux_december_lgr_results_soil.csv")
if(exists("CH4_best_lgr3_december")) {
  write_csv(CH4_best_lgr3_december, "flux_code/CH4_best_flux_december_lgr_results_soil.csv")
}
...
cat("\nFiles updated:\n")
cat("- flux_code/lgr_manual_identification_results_soil.csv (UPDATED)\n")
cat("- flux_code/CO2_flux_lgr_results_soil.csv (UPDATED)\n")
cat("- flux_code/CO2_best_flux_lgr_results_soil.csv (UPDATED)\n")
if(file.exists("flux_code/CH4_flux_lgr_results_soil.csv")) {
  cat("- flux_code/CH4_flux_lgr_results_soil.csv (UPDATED)\n")
}
if(file.exists("flux_code/CH4_best_flux_lgr_results_soil.csv")) {
  cat("- flux_code/CH4_best_flux_lgr_results_soil.csv (UPDATED)\n")
}
cat("- flux_code/semirigid_tree_final_complete_dataset_soil.csv (UPDATED)\n")
cat("- flux_code/LGR3_flux_plots_complete_soil.pdf (UPDATED with new December plots)\n")

cat("\nAdditional December-specific files created:\n")
cat("- flux_code/CO2_best_flux_december_lgr_results_soil.csv (December only)\n")
if(exists("CH4_best_lgr3_december")) {
  cat("- flux_code/CH4_best_flux_december_lgr_results_soil.csv (December only)\n")
}
cat("- flux_code/LGR3_flux_plots_december_soil.pdf (December plots only)\n")
