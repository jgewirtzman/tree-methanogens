...
# Load LGR3 auxfile
lgr3_auxfile <- read_csv("auxfile_goFlux_soilflux_with_weather.csv") %>%
...
write_csv(manID.lgr3, "flux_code/lgr_manual_identification_results_soil.csv")
...
# Save flux results
write_csv(CO2_flux_lgr3, "flux_code/CO2_flux_lgr_results_soil.csv")
if(exists("CH4_flux_lgr3")) {
  write_csv(CH4_flux_lgr3, "flux_code/CH4_flux_lgr_results_soil.csv")
}
...
write_csv(CO2_best_lgr3, "flux_code/CO2_best_flux_lgr_results_soil.csv")
if(exists("CH4_best_lgr3")) {
  write_csv(CH4_best_lgr3, "flux_code/CH4_best_flux_lgr_results_soil.csv")
}
...
original_data <- read_csv("auxfile_goFlux_soilflux_with_weather_formatted.csv")
...
write_csv(final_dataset, "flux_code/semirigid_tree_final_complete_dataset_soil.csv")
