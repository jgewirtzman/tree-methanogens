# ddPCR Data Processing Pipeline
# Tree Microbiome & Methane Research Project
...
# Define file paths
base_path <- '/Users/jongewirtzman/Google Drive/Research/YMF Tree Microbiomes & Methane/Tree Methane Lab/Data/ddPCR Data/Data Files/'
...
# Optional: Save the processed data
 write.csv(final_data, file.path(base_path, "processed_ddpcr_data.csv"), row.names = FALSE)
