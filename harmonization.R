# Final Corrected Tree Data Merging Pipeline
# Removes "untagged" trees, fixes "PB4?" to "pb5", averages remaining duplicates
...
mapping <- read_csv("/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/dbh/tree_id_comprehensive_mapping.csv")
...
dbh <- read_csv("/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/dbh/tree_dbh_consensus_comprehensive.csv")
...
gas <- read_csv("/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/int_gas/sample_data_only.csv")
...
flux <- read_csv("/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/flux_code/methanogen_tree_flux_complete_dataset.csv")
...
soil <- read_csv("/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/static-chambers/field/soil_tree_level_means.csv")
...
wood <- read_csv("/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/tree_cores/tree_core_filled_complete.csv")
...
ddpcr <- read_csv("/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/ddpcr/processed_ddpcr_data.csv")
...
write_csv(merged_data_final, "/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/merged_tree_dataset_final.csv")
cat("\nFinal merged dataset saved as: 'merged_tree_dataset_final.csv'\n")
