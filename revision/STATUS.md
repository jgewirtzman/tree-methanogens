...
- **⚠️ R2 #1e primer sequences — NOT done; needs Jon.** mcrA seqs ARE in ms (L117). For pmoA/mmoX only CITES refs, and sources DISAGREE: ms cites Luesken 2011 + McDonald & Murrell 1997 + McDonald 1995 (all pmoA-ish; NO clear mmoX ref); our note `ddpcr_controls_LoD.md` guessed Luton 2002/Fuse 1998/Bourne 2001 (WRONG — Luton 2002 is mcrA). Did NOT pull actual sequences (don't fabricate). **Jon: confirm which pmoA + mmoX primer pairs were actually run → then pull/format exact sequences + fix citation.**
