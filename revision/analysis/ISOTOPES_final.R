...
#   revision/outputs/ISOTOPES_methods.md      methods text
#   revision/outputs/ISOTOPES_results.md      results text (numbers filled in)
#   revision/outputs/ISOTOPES_fig1_source.png Keeling + convergence panels
#   revision/outputs/ISOTOPES_fig2_crossplot.png  d13CH4 vs d13CO2 + alpha_C isolines
#   revision/outputs/ISOTOPES_sample_table.csv    per-sample data
#
...
#
# Run: Rscript revision/analysis/ISOTOPES_final.R
# ==============================================================================
