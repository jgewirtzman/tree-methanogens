...
#
# NEW file; edits nothing. Run: Rscript revision/analysis/R_copies_per_gram.R
# ==============================================================================
...
bo_sm <- tryCatch(read_csv("revision/data/black_oak/bo_soil_moisture.csv", show_col_types = FALSE),
