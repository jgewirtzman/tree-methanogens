...
# Run: Rscript revision/analysis/R_traits_flux_microbial_bridge.R
# Outputs: revision/outputs/traits_bridge_correlations.csv,
...
source("revision/analysis/_prep_species_data.R")   # analysis_ratio/mcra/meth, flux_by_species
sp <- analysis_ratio %>%
