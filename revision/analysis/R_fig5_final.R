...
# nothing existing. Output: revision/outputs/fig5_final.png
# ==============================================================================
...
mt_defs <- load_methanotroph_defs("revision/data/methanotroph_definitions_revised.csv")  # R2 #2: Methylacidiphilaceae family Known->Putative
...
ggsave("revision/outputs/fig5_final.png",
       fig_combined, width = 14, height = 12, dpi = 300)

cat("Wrote revision/outputs/fig5_final.png (revised methanotroph defs: Methylacidiphilaceae family -> Putative)\n")
