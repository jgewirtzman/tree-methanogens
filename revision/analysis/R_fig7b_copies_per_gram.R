...
# from Black Oak Tree Project Data.xlsx (extracted to revision/data/black_oak/),
...
#
# NEW file; edits nothing existing. Run: Rscript revision/analysis/R_fig7b_copies_per_gram.R
# Outputs: revision/outputs/fig7b_copies_per_gram.png, fig7b_copies_per_gram.csv
# ==============================================================================
...
mass <- read_csv("revision/data/black_oak/bo_extraction_mass.csv", show_col_types = FALSE)
