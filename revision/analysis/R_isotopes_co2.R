...
# coloring is not. See revision/text/isotope_co2_finding.md (correction note).
# ==============================================================================
...
# Run: Rscript revision/analysis/R_isotopes_co2.R
# Outputs (revision/outputs/): iso_co2_*.png, iso_co2_summary.txt, iso_co2_sample_table.csv
# ==============================================================================
