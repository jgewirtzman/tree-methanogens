...
#
# NEW file; edits nothing. Run: Rscript revision/analysis/R_height_slope_vs_moisture.R
# Outputs: revision/outputs/height_slope_vs_moisture.png, height_slope_moisture_summary.txt
# ==============================================================================
