...
# NEW file; edits nothing existing. Output: revision/outputs/fig7_felled_oak_final.png
#
...
bo_mass <- readr::read_csv("revision/data/black_oak/bo_extraction_mass.csv", show_col_types = FALSE)
mcra <- mcra %>%
...
ggsave("revision/outputs/fig7_felled_oak_final.png",
       fig7, width = 12, height = 5.1, dpi = 300)
cat("Wrote revision/outputs/fig7_felled_oak_final.png (copies/g dry; flux unit; DILUTION_10X =", DILUTION_10X, ")\n")
