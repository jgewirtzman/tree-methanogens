...
| `data/compiled/` | 16 analysis-ready datasets with documented columns and units — see `README_data.md` in the archive |
...
Written to `outputs/data/`. These are pipeline results rather than input data, so they live in the code repository rather than in `data/compiled/`.
