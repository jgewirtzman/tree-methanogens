# =============================================================================
# FIXED PLOT CODE - Add to your workflow after Section 11
# =============================================================================
...
ggsave("MONTHLY_FLUX_PREDICTIONS.png", p_monthly, width = 10, height = 6)
...
ggsave("MONTHLY_FLUX_PREDICTIONS_DUAL.png", p_monthly_dual, width = 8, height = 10)
...
ggsave("COMBINED_OBS_VS_PRED.png", p_combined, width = 9, height = 8)
...
ggsave("COMBINED_OBS_VS_PRED_FACET.png", p_combined_facet, width = 12, height = 6)
...
if(nrow(tree_species_filtered) > 0) {
  ...
  ggsave("DIAGNOSTIC_SPECIES_BOXPLOT.png", p_species_box, width = 12, height = 7)
  ...
  ggsave("DIAGNOSTIC_SPECIES_SCATTER.png", p_species_scatter, width = 12, height = 10)
...
ggsave("DIAGNOSTIC_MOISTURE_BOXPLOT.png", p_moisture_box, width = 10, height = 10)
...
ggsave("DIAGNOSTIC_MOISTURE_MEANS.png", p_moisture_means, width = 10, height = 8)
...
ggsave("DIAGNOSTIC_MOISTURE_CONTINUOUS.png", p_moisture_continuous, width = 10, height = 8)
