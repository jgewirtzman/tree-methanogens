...
merged_data <- read.csv('/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/merged_tree_dataset_final.csv')
...
mapping <- read.csv("/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/dbh/tree_id_comprehensive_mapping.csv")
...
# ggsave("combined_flux_plot.tiff", 
#        plot = combined_plot, 
#        width = 8, 
#        height = 7, 
#        units = "in", 
