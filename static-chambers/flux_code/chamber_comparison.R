# Species-Specific Flux Distribution Analysis
# Comparing two different measurement methods
...
# Load the datasets
methanogen_data <- read.csv('/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/flux_code/methanogen_tree_flux_complete_dataset.csv', stringsAsFactors = FALSE)
semirigid_data <- read.csv('/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/flux_code/untitled folder/semirigid_tree_final_complete_dataset.csv', stringsAsFactors = FALSE)
species_mapping <- read.csv('/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/to-organize/yale-forest-ch4/Yale Myers Methane Project/spatial_data/YM_trees_measured.csv.csv', stringsAsFactors = FALSE)
...
rigid_data <- read.csv('/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/flux_code/methanogen_tree_flux_complete_dataset.csv', stringsAsFactors = FALSE)
semirigid_data <- read.csv('/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/flux_code/untitled folder/semirigid_tree_final_complete_dataset.csv', stringsAsFactors = FALSE)
species_mapping <- read.csv('/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/to-organize/yale-forest-ch4/Yale Myers Methane Project/spatial_data/YM_trees_measured.csv.csv', stringsAsFactors = FALSE)
