...
# Set data path
data_path <- '/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/static-chambers/2021 raw flux data'
...
# Load LGR3 auxfile
lgr3_auxfile <- read_csv('/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/static-chambers/flux_code/goflux_auxfile.csv') %>%
...
write_csv(manID.lgr3, "flux_code/lgr_manual_identification_results.csv")
...
# Save flux results
write_csv(CO2_flux_lgr3, "flux_code/CO2_flux_lgr_results.csv")
if(exists("CH4_flux_lgr3")) {
  write_csv(CH4_flux_lgr3, "flux_code/CH4_flux_lgr_results.csv")
}
...
write_csv(CO2_best_lgr3, "flux_code/CO2_best_flux_lgr_results.csv")
if(exists("CH4_best_lgr3")) {
  write_csv(CH4_best_lgr3, "flux_code/CH4_best_flux_lgr_results.csv")
}
...
flux2pdf(
  ...
  outfile = "flux_code/LGR3_flux_plots_complete_ymf_methanogens.pdf",
  width = 11.6,
  height = 8.2
)
...
original_data <- read_csv('/Users/jongewirtzman/My Drive/Research/YMF Tree Microbiomes & Methane/tree-methanogens/static-chambers/flux_code/goflux_auxfile.csv')
...
write_csv(final_dataset, "flux_code/methanogen_tree_flux_complete_dataset.csv")
