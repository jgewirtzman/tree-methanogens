# =============================================================================
# REPROCESS SPECIFIC FAILED MEASUREMENTS
# =============================================================================
...
if(length(failed_window_indices) > 0) {
  ...
  manID_reprocessed <- click.peak2(
    ...
    save.plots = "flux_code/lgr3_reprocessed_failed_plots"
  )
  ...
  write_csv(manID.lgr3, "flux_code/lgr_manual_identification_results_final.csv")
  write_csv(final_summary, "flux_code/lgr_manual_identification_summary_final.csv")
